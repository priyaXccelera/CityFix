...
class GatewayRoutingTest {
  ...
  private static final int GATEWAY_PORT = 27357;
  ...
  @Test
  void routesToAdminAnnouncementService() throws Exception {
    assertRoute("admin-announcement-service");
  }

  @Test
  void routesToIssueService() throws Exception {
    assertRoute("issue-service");
  }
